...
uint32_t pfcp_teid_roll_the_dice(struct pfcp_router *r, struct in_addr *ipv4,
				 struct in6_addr *ipv6);
struct pfcp_teid *pfcp_teid_alloc(struct pfcp_router *r, uint32_t id,
				  struct in_addr *ipv4,
				  struct in6_addr *ipv6);
struct pfcp_teid *pfcp_teid_restore(struct pfcp_router *r,
