...
#    # sudo ip netns exec router-priv ping -I 10.0.0.1 -c 1 8.8.8.8
#
...
ip route add 10.0.0.0/8 via 192.168.62.1 dev gre-priv table 1320
ip route add 37.141.0.0/24 via 192.168.62.1 dev gre-priv table 1320
